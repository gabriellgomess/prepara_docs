    ...
    for (let i = 0; i < pageCount; i++) {
      ...
      for (let r = 0; r < cutPoints.length; r++) {
        ...
        if (!fileName.startsWith('recibo_')) {
          ...
          link.className = 'inline-block bg-gradient-to-r from-red-800 to-red-700 text-white hover:from-red-700 hover:to-red-600 border border-red-800 rounded-full px-3 py-1.5 font-medium text-xs transition-all duration-200 hover:scale-105 shadow-sm hover:shadow-md cursor-pointer';
